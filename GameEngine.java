...
public class GameEngine{
    ...
    public List<Location> mazeToLocations(Maze scan_maze){
    ...
    public void runGame(){
		...
		while (!is_done){
			...
			System.out.print("Coins Collected for Team 1: ");
			System.out.println(state.team_one_coins);
			System.out.print("Coins Collected for Team 2: ");
    ...
    public void addRobots(boolean teamOne, List<? extends Robot> robots){
    ...
    public Maze doTeamScan(boolean teamOne){
    ...
    public void addFreeCommands(List<Command> cmds, List<MazeRobot> bots){
		for(MazeRobot r : bots){
    ...
    public List<Robot> getReadyRobots(boolean teamOne, boolean extra_turn){
    ...
    public List<MazeRobot> getTeamRobots(boolean teamOne){
